...
class MyTestCase(unittest.TestCase):
    def test_swap_one(self):
        ...
        self.assertEqual(str(expected), intro_lists.swap(list1))
    ...
    def test_rotate_left_one(self):
        list1 = [1, 2, 3]
        expected = [2, 3, 1]
        self.assertEqual(str(expected),intro_lists.rotate_left(list1))
...
"""
    ...
    def test_max_end_two(self):
        list1 = [98, 99, -1]
        expected = [98, 98, 98]
        self.assertEqual(str(expected),intro_lists.max_end(list1))
